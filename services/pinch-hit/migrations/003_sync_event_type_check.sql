...
FROM evaluation_log
WHERE event_type IN (
    'alert_fired', 'alert_confirmed', 'mlb_substitution', 'tweet_parsed',
    'tweet_received', 'tweet_rejected', 'unmatched_substitution', 'twitter_degraded',
    'alert_timeout', 'twitter_recovered', 'schedule_api_outage', 'schedule_api_recovered'
);
