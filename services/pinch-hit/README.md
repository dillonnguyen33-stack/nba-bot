...
Async event-driven rewrite of the pinch-hit alert bot. Receives reporter tweets via twitterapi.io WebSocket, confirms via MLB GUMBO, posts two-tier Discord alerts.
...
- `503 Service Unavailable` — Twitter WebSocket gap > 150s during game hours
